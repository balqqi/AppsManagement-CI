        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                     <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#addModal"><span class="fa-fw select-all fas"></span> Add Roles</button>
            ...
            <div class="row">
                <div class="col-12 col-xl-12">
                    ...
                    <tbody>
                         ...
                         <?php $i=1; foreach($data_roles as $value): ?>
                        <tr>
                            <td>
                                 <a href="javascript:void(0);" title="Edit" class="item-update" data-id="<?= $value['project_group_id']?>">
                                                         <span class="fa-fw select-all fas"></span>
                                <a href="javascript:void(0);" title="Delete" class="item-delete" data-id="<?= $value['project_group_id']?>">
                                                         <span class="fa-fw select-all fas"></span>
                            </td>
                                                         ...
                                                         <div class="col-md-12">
                                                            <div class="form-group row align-items-center">
                                                                ...
                                                                <div class="col-lg-10 col-9">
                                                                    ...
                                                                    <input type="text" id="project_group_name" class="form-control" name="project_group_name" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                         <div class="col-md-12">
         ...
         let jquery_datatable = $("#table1").DataTable();
            ...
            $.ajax({
                ...
                success: function(response){
                    $("#addModal").modal('show');
                    $("#primary_key").val(response[0].project_group_id);
                     $("#project_group_name").val(response[0].project_group_name);
